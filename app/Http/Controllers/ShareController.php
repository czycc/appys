        ...
        switch ($type) {
            ...
            case 'company_post':
                if ($user = User::find($user_id)) {
                    $url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx5d2b37e7c2938683&redirect_uri=http://api.woheni99.com/CompanyArticleDetail?id={$id}&{$user->phone}&response_type=code&scope=snsapi_base&state=share";
                } else {
